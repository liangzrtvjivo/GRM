...
class GATLayerImp3(GATLayer):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, concat=True, activation=nn.ELU(),
        ...
        self.pos_embed_layer = PositionalEmbedding(num_out_features)
    ...
    def forward(self, data):
        ...
        in_nodes_features, edge_index, edge_type = data  # unpack data
        ...
        if edge_type!=None:
            pos_emb = self.pos_embed_layer(edge_type).unsqueeze(1)
            pos_emb = pos_emb.repeat(1, self.num_of_heads, 1)
            nodes_features_proj_lifted = nodes_features_proj_lifted + pos_emb

...
--learning_rate $lr --batch_size 256 --cuda 0 --model_type 'glyph_sa_1_small_bn' \
...
python infer.py --output_file '_CoNLL_'$INFER_INDEX \
    ...
    --batch_size 256 --oov_file '../downstream/bert_1/bert_ner/output_oov/words_conll_oov.txt' --cuda 0 \
    --config './experiments_bert.conf'
echo _CoNLL_------------------------------------------------------------------------

cd ../downstream/bert_1/bert_ner
